...
class DatabaseService extends ChangeNotifier {
  ...
  void _loadSeedData() {
    ...
    _expenses = [
      ...
      Expense(
        id: 'seed-2',
        title: 'WinMart+ Tiêu dùng',
        amount: 173000,
        category: ExpenseCategory.gear,
        date: now.subtract(const Duration(days: 1, hours: 2)),
        merchant: 'WinMart+',
        note: 'Sữa tươi, bánh mì, đồ dùng cá nhân',
        isOcrScanned: true,
      ),
      Expense(
        id: 'seed-3',
      ...
      Expense(
        id: 'seed-4',
        title: 'Giáo trình & Sách học',
        amount: 190000,
        category: ExpenseCategory.study,
        date: now.subtract(const Duration(days: 3)),
        merchant: 'Nhà Sách Fahasa',
        note: 'Giáo trình lập trình & vở sinh viên',
        isOcrScanned: true,
      ),
      Expense(
        id: 'seed-5',
        title: 'Phụ kiện máy tính (Gear)',
        amount: 250000,
        category: ExpenseCategory.gear,
        date: now.subtract(const Duration(days: 4)),
        merchant: 'Phong Vũ',
        note: 'Chuột quang và lót chuột',
        isOcrScanned: false,
      ),
      Expense(
        id: 'seed-6',
        ...
        note: 'Vé xem phim cuối tuần cùng CLB',
        isOcrScanned: false,
      ),
    ];
    _expenses.sort((a, b) => b.date.compareTo(a.date));
